def aes_stream_cipher(key, data_array, encrypt):
...
cipher = aes_stream_cipher(key, plaintext, True)
print(cipher)

# Decrypt the ciphertext
decrypted_plaintext = aes_stream_cipher(key, cipher, False)

# Convert the decrypted bytes to hexadecimal strings
